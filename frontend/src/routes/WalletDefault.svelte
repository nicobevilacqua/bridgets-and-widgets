...
<div class="container mx-auto WalletWidgetMain">
	<div
		class="mx-auto my-10 p-6 max-w-lg bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700"
	>
		...
		<div class="flex justify-center flex-col mx-auto w-full text-center max-w-lg">
			<div class="border rounded-lg flex flex-row mx-auto mt-14">
				<a
					class="p-2 m-1 rounded-lg w-28 uppercase text-sm font-semibold text-black no-underline hover:no-underline bg-slate-300"
					href="./">Mint</a
				>
				<a
					class="p-2 m-1 rounded-lg w-28 uppercase text-sm font-semibold text-black no-underline hover:no-underline hover:bg-slate-100"
          ...
          {/if} -->
				...
				<div>
					{#if !$wallet}
						<button
							class="bg-blue-500 hover:bg-blue-600 text-2xl text-white w-full rounded-xl py-4 font-semibold mt-4"
							on:click|preventDefault={login}>Connect wallet</button
						>
					{:else if $chainId != 31337}
						<button
							class="bg-red-500 hover:bg-red-600 text-2xl text-white w-full rounded-xl py-4 font-semibold mt-4"
							on:click|preventDefault={changeNetwork}>Connect to Local</button
						>
					{:else}
						<button
							class="bg-blue-500 hover:bg-blue-600 text-2xl text-white w-full rounded-xl py-4 font-semibold mt-4"
